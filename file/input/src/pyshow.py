...
# sei   = sp.ReadDat('./sei_nz853_nx2317_dx5_dz5.dat', [nz, nx], dtype='float32')
sei   = sp.ReadDat('./sei_noise.dat', [nz, nx], dtype='float32')
_w     = sp.ReadDat('./w.dat', [nz-3, 1], dtype='float32')
w=np.zeros((nz,1))
w[0:nz-3]=_w
...
_cw    = sp.ReadDat('./cw.dat', [nz-3, 1], dtype='float32')
cw=np.zeros((nz,1))
cw[0:nz-3]=_cw

nsei  = sp.ReadDat('./new_sei_nz853_nx2317_dx5_dz5.dat',
        [nz, nx], dtype='float32')
